...
{
    identi = parseInt(Math.random()*1000000000000000);
...
function cargarConex2()
{   
    $("#myModal2").modal('hide');
    console.log("acepto");
}
//Abrir el modal de la configuración
function abrirmodal()
{
    $("#cargagrafo tr").remove();
    if (document.getElementById("endPoint").value == "")
     {
        document.getElementById("endPoint").value="http://data.utpl.edu.ec/ambar/sparql";
     }
...
function borrarPanelfiltert(id)
{
    var alerta = "Elimino panel "+id;
    console.log(alerta);
    var x ="#"+id;
...
function GetCampos()
{
    ...
    //
    var consultatextito = document.getElementById("Consulta").innerHTML;
        bootbox.dialog({
          message: consultatextito,
          title: "Su consulta ",
          buttons: {
            success: {
              label: "Ejecutar",
